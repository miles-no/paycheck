  ...
  return (
    <div>
      <div className="flex flex-row justify-between text-white">
        <div >
          <p className ="flex flex-row whitespace-nowrap">Du har ført &nbsp;  <div className="text-[#78E8DB] ">{totalHoursInvoiced} </div> &nbsp; av 172,5 timer denne måneden</p>
        </div>
        <div>
      ...
      <div className="progress-bar">
        ...
        <div className="flex flex-row  align-items: center; justify-end" >
